  ...
  return (
    <div className="nx-card-container nx-card-container--column">
      ...
      <div className="nx-card nx-card--horizontal">
        ...
        <footer className="nx-card-footer"><a href="nx-text-link">Artisanal denim</a></footer>
      </div>
      <div className="nx-card nx-card--horizontal">
        <div className="nx-card__call-out">
        ...
        <footer className="nx-card-footer"><a href="nx-text-link">Film sprawl wristwatch math-engine</a></footer>
      </div>
      <div className="nx-card nx-card--horizontal">
        <div className="nx-card__call-out">
        ...
        <footer className="nx-card-footer"><a href="nx-text-link">Jabberwocky</a></footer>
      </div>
      <div className="nx-card nx-card--horizontal">
        <div className="nx-card__call-out">
        ...
        <footer className="nx-card-footer">
          <a href="nx-text-link">uplink numinous pen</a>
        </footer>
      </div>
      <div className="nx-card nx-card--horizontal">
        <div className="nx-card__call-out">
        ...
        <footer className="nx-card-footer"><a href="nx-text-link">digital military-grade j-pop-ware</a></footer>
      </div>
    </div>
  );
}