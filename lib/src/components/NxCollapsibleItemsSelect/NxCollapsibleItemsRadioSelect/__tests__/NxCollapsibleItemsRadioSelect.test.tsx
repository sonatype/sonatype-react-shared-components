...
import NxCollapsibleItemsRadioSelect, {Option, Props} from '../NxCollapsibleItemsRadioSelect';
...
describe('NxCollapsibleItemsRadioSelect', function() {
  ...
  const getShallow = getShallowComponent<Props>(NxCollapsibleItemsRadioSelect, requiredProps);
