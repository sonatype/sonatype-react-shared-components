...
import { NxNavigationDropdown, useToggle, NxTextLink, NxH4, NxP } from '@sonatype/react-shared-components';

function NxNavigationDropdownHeaderExample() {
...
export default NxNavigationDropdownHeaderExample;
