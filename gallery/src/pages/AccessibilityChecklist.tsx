    ...
    <GalleryTile title="WCAG Accessibility UX Checklist" className="nx-tile--accessibility-list">
      ...
      <NxList>
        ...
        <NxList.Item className={`level-aaa ${isAAA && 'hidden'}`}>
          ...
          <NxList.Actions>
            <NxTextLink external href="https://www.w3.org/WAI/WCAG21/quickref/#extended-audio-description-prerecorded">
              Level AAA
            </NxTextLink>
          </NxList.Actions>
        </NxList.Item>
      ...
      <NxList>
        ...
        <NxList.Item className={`level-a ${isA && 'hidden'}`}>
          <NxList.Text>
            <NxCheckbox isChecked={false}>
              Have we made sure to not use physical characteristics like color or location to explain how to accomplish
              a task?
            </NxCheckbox>
          </NxList.Text>
          <NxList.Actions>
      ...
      <NxList>
        ...
        <NxList.Item className={`level-aaa ${isAAA && 'hidden'}`}>
          <NxList.Text>
            <NxCheckbox isChecked={false}>
              If our content is very complex, have we provided additional supporting materials to help users understand
              it at a middle school reading level?
            </NxCheckbox>
          </NxList.Text>
          <NxList.Actions>
            <NxTextLink external href="https://www.w3.org/WAI/WCAG21/quickref/#reading-level">
