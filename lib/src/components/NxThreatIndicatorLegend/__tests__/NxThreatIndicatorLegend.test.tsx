...
describe('NxThreatIndicatorLegend', function() {
  ...
  it('renders the correct legend item', function() {
    ...
    expect(component.find('.nx-threat-indicator-legend__name').at(0)).toHaveText('Critical');
    ...
    expect(component.find('.nx-threat-indicator-legend__name').at(1)).toHaveText('Low');
  });
