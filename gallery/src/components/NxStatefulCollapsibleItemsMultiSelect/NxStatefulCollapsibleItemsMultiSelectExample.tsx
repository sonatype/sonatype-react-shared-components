...
const NxStatefulCollapsibleItemsMultiSelectExample = () => {
  const options = [
    {
      id: 'bike',
      name: 'Bicycle'
  ...
  return (
    <NxStatefulCollapsibleItemsMultiSelect name="travel"
                                           id="stateful-travel"
                                           options={options}
...
export default NxStatefulCollapsibleItemsMultiSelectExample;
