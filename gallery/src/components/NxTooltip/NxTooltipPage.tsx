          ...
          <NxTable.Body>
            ...
            <NxTable.Row>
              ...
              <NxTable.Cell>
                ...
                the tooltip flush to the left edge of the element, "top-middle" and "bottom-middle" center the tooltip, while "top-end" and "bottom-end" position it flush to the right edge.
              </NxTable.Cell>
            </NxTable.Row>
            <NxTable.Row>
