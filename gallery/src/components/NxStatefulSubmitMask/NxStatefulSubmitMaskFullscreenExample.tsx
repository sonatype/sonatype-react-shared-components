...
function NxStatefulSubmitMaskFullscreenExample() {
  ...
  return (
    <div className="gallery-submit-mask-area">
      ...
      { maskSuccess != null && <NxStatefulSubmitMask success={maskSuccess} fullscreen /> }
    </div>
  );
}

export default NxStatefulSubmitMaskFullscreenExample;
