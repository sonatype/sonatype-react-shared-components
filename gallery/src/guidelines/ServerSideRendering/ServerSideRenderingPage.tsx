...
import { NxP, NxCode, NxPre } from '@sonatype/react-shared-components';
  ...
  <>
    <GalleryDescriptionTile>
      <NxP>
        ...
        page. In particular, RSC supports the next.js framework SSR. However,
        there are certain configurations and utilities that a project must use
      ...
      <NxP>
        ...
        components. For more details and an example, see
        https://gallery.sonatype.dev/#/pages/Server%20Side%20Rendering%20Utilities
      </NxP>
    </GalleryDescriptionTile>
  </>;
