...
describe('NxNavigationDropdown', () => {
  const minimalProps: Props = {
      ...
      quickRender = rtlRender(NxNavigationDropdown, minimalProps),
      renderEl = rtlRenderElement(NxNavigationDropdown, minimalProps);
  ...
  it('correctly renders the menu based on isOpen prop', function() {
    ...
    rerender(<NxNavigationDropdown { ...minimalProps } isOpen={false} />);
  ...
  it('moves focus to the dropdown toggle button if a menu item is focused when the dropdown is closed',
      async function() {
        ...
        rerender(<NxNavigationDropdown { ...minimalProps } {...props} isOpen={false} />);
