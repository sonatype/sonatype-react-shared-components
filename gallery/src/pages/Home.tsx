...
// IE11 doesn't support navigator.languages but has a non-standard userLanguage property
const language = (navigator as any).userLanguage || navigator.languages[0];
...
const Home = () => {
  ...
  return (
    <GalleryTile title="Welcome to the Sonatype React Shared Components Gallery">
      ...
      <section className="nx-tile-subsection">
        <DateRangePicker locale={language} onChange={setDates} value={dates} />
      </section>
    </GalleryTile>
  );
};
