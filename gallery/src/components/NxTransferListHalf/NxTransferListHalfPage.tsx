...
const NxTransferListPage = () =>
  <>
    ...
    <GalleryExampleTile title="Long List Example"
      ...
      Demonstrates an <NxCode>NxTransferListHalf</NxCode> with a long list. Previous versions of
      this component suffered from performance issues when the list is very long. To address this,
      it has been updated to use <NxCode>NxScrollRender</NxCode> to render
