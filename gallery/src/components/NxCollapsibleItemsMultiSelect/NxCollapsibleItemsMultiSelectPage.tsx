...
import NxCollapsibleItemsMultiSelectExample from './NxCollapsibleItemsMultiSelectExample';
import NxCollapsibleItemsMultiSelectCustomTooltipExample from './NxCollapsibleItemsMultiSelectCustomTooltipExample';
import NxCollapsibleItemsMultiSelectDisabledExample from './NxCollapsibleItemsMultiSelectDisabledExample';

const NxCollapsibleItemsMultiSelectExampleCode = require('./NxCollapsibleItemsMultiSelectExample?raw'),
    NxCollapsibleItemsMultiSelectDisabledExampleCode = require('./NxCollapsibleItemsMultiSelectDisabledExample?raw'),
    NxCollapsibleItemsMultiSelectCustomTooltipExampleCode =
        require('./NxCollapsibleItemsMultiSelectCustomTooltipExample?raw');

const NxCollapsibleItemsMultiSelectPage = () =>
  <>
    ...
    <GalleryExampleTile title="NxCollapsibleItemsMultiSelect Example"
                        id="nx-tree-view-multi-select-example"
                        liveExample={NxCollapsibleItemsMultiSelectExample}
                        codeExamples={NxCollapsibleItemsMultiSelectExampleCode}>
      Basic example of a <NxCode>NxCollapsibleItemsMultiSelect</NxCode>. Note that the overflowing label gets
      a tooltip.
    </GalleryExampleTile>

    <GalleryExampleTile title="NxCollapsibleItemsMultiSelect Custom Tooltip Example"
                        id="nx-tree-view-multi-select-custom-tooltip-example"
                        liveExample={NxCollapsibleItemsMultiSelectCustomTooltipExample}
                        codeExamples={NxCollapsibleItemsMultiSelectCustomTooltipExampleCode}>
      Example of an <NxCode>NxCollapsibleItemsMultiSelect</NxCode> which generates a tooltip for each option
      based on a custom field.
    </GalleryExampleTile>

    <GalleryExampleTile title="NxCollapsibleItemsMultiSelect Disabled Example With Tooltip"
                        liveExample={NxCollapsibleItemsMultiSelectDisabledExample}
                        codeExamples={NxCollapsibleItemsMultiSelectDisabledExampleCode}>
      An example of an <NxCode>NxCollapsibleItemsMultiSelect</NxCode> which is disabled and which displays
      a tooltip to explain why.
    </GalleryExampleTile>
  </>;

export default NxCollapsibleItemsMultiSelectPage;
