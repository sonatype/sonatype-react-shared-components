...
const NxStatefulCollapsibleRadioSelectDisabledExample = () => {
  const options = [
    {
      id: 'bike',
      name: 'Bicycle'
  ...
  return (
    <NxStatefulCollapsibleRadioSelect name="travel-disabled"
...
export default NxStatefulCollapsibleRadioSelectDisabledExample;
