...
import { NxIconDropdown, NxButton, useToggle, NxTextLink } from '@sonatype/react-shared-components';
...
function NxIconDropdownNavigationExample() {
  ...
  return (
    <div className="nx-btn-bar">
      ...
      <NxButton>Another Test Button</NxButton>
    </div>
  );
}
