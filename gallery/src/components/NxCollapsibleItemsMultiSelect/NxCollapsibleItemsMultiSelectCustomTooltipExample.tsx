...
interface CustomOption extends NxCollapsibleItemsMultiSelectOption {
  description: string;
}

const NxCollapsibleItemsMultiSelectCustomTooltipExample = () => {
  ...
  return (
    <NxCollapsibleItemsMultiSelect name="travel-custom-tooltips"
...
export default NxCollapsibleItemsMultiSelectCustomTooltipExample;
