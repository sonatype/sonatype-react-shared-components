...
describe('nx-list', function() {
  ...
  const simpleSelector = '#nx-list-simple-example .gallery-example-live',
      ...
      clickableSelector = '#nx-list-clickable-links-example .nx-list',
  ...
  describe('Clickable links nx-list', function() {
    it('looks right with a row hovered', hoverTest(clickableLinksSelector, `${clickableSelector} li:first-child`));
  });
