...
import NxStatefulCollapsibleItemsRadioSelect, {Props, Option} from '../NxStatefulCollapsibleItemsRadioSelect';

describe('NxStatefulCollapsibleItemsRadioSelect', function() {
  ...
  const getShallow = getShallowComponent<Props>(NxStatefulCollapsibleItemsRadioSelect, requiredProps);

  it('properly renders component using only required props', function() {
    const shallowRender = getShallow();

    expect(shallowRender).toHaveDisplayName('NxCollapsibleItemsRadioSelect');
  ...
  it('passes props to NxCollapsibleItemsRadioSelect', function() {
    const optionalProps = {
      id: 'someid',
      isOpen: true,
      disabled: true,
