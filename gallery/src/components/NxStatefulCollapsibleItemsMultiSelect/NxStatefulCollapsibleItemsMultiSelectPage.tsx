...
import NxStatefulCollapsibleItemsMultiSelectExample from './NxStatefulCollapsibleItemsMultiSelectExample';
import NxStatefulCollapsibleItemsMultiSelectDisabledExample
  from './NxStatefulCollapsibleItemsMultiSelectDisabledExample';

const nxStatefulCollapsibleItemsMultiSelectExampleCode = require('./NxStatefulCollapsibleItemsMultiSelectExample?raw'),
    nxStatefulCollapsibleItemsMultiSelectDisabledExampleCode =
        require('./NxStatefulCollapsibleItemsMultiSelectDisabledExample?raw');

const NxStatefulCollapsibleItemsMultiSelectPage = () =>
  <>
    ...
    <GalleryExampleTile title="General Example"
                        ...
                        liveExample={NxStatefulCollapsibleItemsMultiSelectExample}>
      This example demonstrates basic usage of <NxCode>NxStatefulCollapsibleItemsMultiSelect</NxCode>. Note that
    ...
    <GalleryExampleTile title="Disabled Example With Tooltip"
                        liveExample={NxStatefulCollapsibleItemsMultiSelectDisabledExample}
                        codeExamples={nxStatefulCollapsibleItemsMultiSelectDisabledExampleCode}>
      This example shows a disabled <NxCode>NxStatefulCollapsibleItemsMultiSelect</NxCode> with a tooltip.
    </GalleryExampleTile>
  </>;

export default NxStatefulCollapsibleItemsMultiSelectPage;
