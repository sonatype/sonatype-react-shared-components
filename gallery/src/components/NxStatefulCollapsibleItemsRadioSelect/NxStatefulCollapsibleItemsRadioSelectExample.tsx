...
const NxStatefulCollapsibleItemsRadioSelectExample = () => {
  const options = [
    {
      id: 'bike',
      name: 'Bicycle'
  ...
  return (
    <NxStatefulCollapsibleItemsRadioSelect name="travel"
                                           id="stateful-travel"
                                           options={options}
...
export default NxStatefulCollapsibleItemsRadioSelectExample;
