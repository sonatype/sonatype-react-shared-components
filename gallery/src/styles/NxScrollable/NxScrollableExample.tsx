...
const NxScrollableExample = () =>
  <div className="nx-scrollable">
    ...
    <p>
      ...
      pen voodoo god systema Chiba. pen papier-mache saturation point crypto- uplink Shibuya knife sub-orbital faded
      tiger-team render-farm geodesic savant Legba. sensory nano- dolphin construct sentient sunglasses motion uplink
      lights uplink gang bomb sentient faded.
    </p>
  </div>;

export default NxScrollableExample;
