  ...
  <>
    <GalleryDescriptionTile>
      ...
      <table className="nx-table nx-table--gallery-props">
        ...
        <tbody>
          <tr className="nx-table-row">
            <td className="nx-cell"><NxCode>.nx-counter</NxCode></td>
            <td className="nx-cell">Top level</td>
            <td className="nx-cell">Basic counter styling. Supports # of # and text string.</td>
          </tr>
          <tr className="nx-table-row">
            <td className="nx-cell"><NxCode>.nx-counter--active</NxCode></td>
            <td className="nx-cell">Modifier of <NxCode>.nx-counter</NxCode></td>
