...
import NxStatefulNavigationDropdown, { Props } from '../NxStatefulNavigationDropdown';

/**
 * Note: this is essentially a copy of the tests for NxStatefulIconDropdown, as this component is the same
 * thing but with an extra CSS class (which is an implementation detail)
 */
describe('NxStatefulNavigationDropdown', () => {
  const minimalProps: Props = {
        title: 'stateful dropdown',
        children: <a>Hello</a>
      },
      quickRender = rtlRender(NxStatefulNavigationDropdown, minimalProps),
      renderEl = rtlRenderElement(NxStatefulNavigationDropdown, minimalProps);
  ...
  it('does not close the dropdown when the Escape key is pressed and dropdown is disabled', async function() {
    ...
    rerender(<NxStatefulNavigationDropdown {...minimalProps} disabled={true}/>);
