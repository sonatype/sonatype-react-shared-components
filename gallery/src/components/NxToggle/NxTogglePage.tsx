...
import NxToggleNowrapExample from './NxToggleNowrapExample';

const exampleCode = require('!!raw-loader!./NxToggleExample').default;
const nowrapExampleCode = require('!!raw-loader!./NxToggleNowrapExample').default;
...
const NxTogglePage = () =>
  <>
    ...
    <GalleryExampleTile title="Checkbox label should not wrap"
                        liveExample={NxToggleNowrapExample}
