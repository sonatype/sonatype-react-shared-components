...
describe('MultiSelectCounter', function() {
  ...
  it('renders active NxCollapsibleItemsCounter when all options are selected', function() {
    const shallowRender = getShallow({
  ...
  it('renders active NxCollapsibleItemsCounter when some options are selected', function() {
    const shallowRender = getShallow({
