      ...
      <table className="nx-table nx-table--gallery-props">
        ...
        <tbody>
          ...
          <tr className="nx-table-row">
            ...
            <td className="nx-cell">Modifier of <code className="nx-code">.nx-cell</code></td>
            <td className="nx-cell">
               This class creates a narrow column suitable for holding a single icon.
               The chevron is used for "clickable" rows and indicates
               that a navigation event will occur if the table row is clicked.
            </td>
          </tr>
        </tbody>
      </table>
