...
import NxStatefulCollapsibleItemsRadioSelectExample from './NxStatefulCollapsibleItemsRadioSelectExample';
import NxStatefulCollapsibleItemsRadioSelectDisabledExample
  from './NxStatefulCollapsibleItemsRadioSelectDisabledExample';

const nxStatefulCollapsibleItemsRadioSelectExampleCode = require('./NxStatefulCollapsibleItemsRadioSelectExample?raw'),
    nxStatefulCollapsibleItemsRadioSelectDisabledExampleCode =
        require('./NxStatefulCollapsibleItemsRadioSelectDisabledExample?raw');

const NxStatefulCollapsibleItemsRadioSelectPage = () =>
  <>
    ...
    <GalleryExampleTile title="General Example"
                        ...
                        liveExample={NxStatefulCollapsibleItemsRadioSelectExample}>
      This example demonstrates basic usage of <NxCode>NxStatefulCollapsibleItemsRadioSelect</NxCode>. Note that
    ...
    <GalleryExampleTile title="Disabled Example With Tooltip"
                        liveExample={NxStatefulCollapsibleItemsRadioSelectDisabledExample}
                        codeExamples={nxStatefulCollapsibleItemsRadioSelectDisabledExampleCode}>
      This example shows a disabled <NxCode>NxStatefulCollapsibleItemsRadioSelect</NxCode> with a tooltip.
    </GalleryExampleTile>
  </>;

export default NxStatefulCollapsibleItemsRadioSelectPage;
