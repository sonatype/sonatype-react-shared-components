 ...
 */
const NxStatefulNumberInput = forwardRef<HTMLDivElement, Props>(
    function NxStatefulNumberInput(props, ref) {
...
NxStatefulNumberInput.propTypes = propTypes;

export default NxStatefulNumberInput;
