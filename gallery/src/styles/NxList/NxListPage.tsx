  ...
  <>
    <GalleryDescriptionTile>
      ...
      <table className="nx-table nx-table--gallery-props">
        ...
        <tbody>
          <tr className="nx-table-row">
            <td className="nx-cell"><NxCode>.nx-list</NxCode></td>
            <td className="nx-cell">Top-Level</td>
            <td className="nx-cell">The parent list class. It has no bullets.</td>
          </tr>
          <tr className="nx-table-row">
            <td className="nx-cell"><NxCode>.nx-list--clickable</NxCode></td>
            <td className="nx-cell">Modifier of <NxCode>.nx-list</NxCode></td>
          ...
          <tr className="nx-table-row">
            <td className="nx-cell"><NxCode>.nx-list--bulleted</NxCode></td>
            <td className="nx-cell">Modifier of <NxCode>.nx-list</NxCode></td>
            <td className="nx-cell">If you need a list with bullets.</td>
          </tr>
          <tr className="nx-table-row">
            <td className="nx-cell"><NxCode>.selected</NxCode></td>
            <td className="nx-cell">
          ...
          <tr className="nx-table-row">
            <td className="nx-cell"><NxCode>.nx-list__subtext</NxCode></td>
            <td className="nx-cell">Element</td>
            <td className="nx-cell">
              When you want a separate line below the main list item use a <NxCode>&lt;p&gt;</NxCode>
              with <NxCode>.nx-list__subtext</NxCode>
            </td>
          </tr>
          <tr className="nx-table-row">
            <td className="nx-cell"><NxCode>.nx-list__actions</NxCode></td>
          ...
          <tr className="nx-table-row">
            <td className="nx-cell"><NxCode>.nx-list__item--empty</NxCode></td>
            <td className="nx-cell">Modifier of <NxCode>.nx-list__item</NxCode></td>
            <td className="nx-cell">Used when there are no list items returned.</td>
          </tr>
          <tr className="nx-table-row">
            <td className="nx-cell"><NxCode>nx-list__item--error</NxCode></td>
            <td className="nx-cell">Modifier of <NxCode>.nx-list__item</NxCode></td>
            <td className="nx-cell">
