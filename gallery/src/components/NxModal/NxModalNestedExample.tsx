    ...
    <>
      ...
      { showModal &&
        <NxModal variant="narrow"
            ...
            <NxModal variant="narrow"
              ...
              <footer className="nx-footer">
                <div className="nx-btn-bar">
                  <NxButton variant="primary" onClick={toggleButton2} style={buttonStyle2}>Hide Button</NxButton>
                  <NxButton onClick={() => alert('Boo!')}>Boo!</NxButton>
          ...
          <div className="nx-modal-content">
            <NxButton onClick={toggleButton} style={buttonStyle}>Hide Button</NxButton>
            <NxButton variant="primary" onClick={toggleNestedModal}>Open Nested Modal</NxButton>
          </div>
          <footer className="nx-footer">
            <div className="nx-btn-bar">
