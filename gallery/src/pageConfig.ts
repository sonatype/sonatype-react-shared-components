...
const pageConfig: PageConfig = {
  ...
  'Layout': {
    ...
    GlobalSidebar: { content: NxGlobalSidebarPage, type: 'react' },
    StatefulGlobalSidebar: { content: NxStatefulGlobalSidebarPage, type: 'react' },
    GlobalSidebarFooter: { content: NxGlobalSidebarFooterPage, type: 'react' },
    'grid': { content: NxGridPage, type: 'html' },
    'Read-Only Grid Tile Layout': { content: NxReadOnlyGridTilePage, type: 'html' },
    NexusPageHeader: { content: NxNexusPageHeaderPage, type: 'react' },
    PageHeader: { content: NxPageHeaderPage, type: 'react' },
    'page-title': { content: NxPageTitlePage, type: 'html' },
    'tile': { content: NxTilePage, type: 'html' },
    VulnerabilityDetails: { content: NxVulnerabilityDetailsPage, type: 'react' }
  },
  'Navigation': {
    Back_Button: { content: NxBackButtonPage, type: 'react' },
    Dropdown: { content: NxDropdownPage, type: 'react' },
    Stateful_Dropdown: { content: NxStatefulDropdownPage, type: 'react' },
    Icon_Dropdown: { content: NxIconDropdownPage, type: 'react' },
    Stateful_Icon_Dropdown: { content: NxStatefulIconDropdownPage, type: 'react' },
    Text_Link: { content: NxTextLinkPage, type: 'react' }
  },
  'Other Components': {
  ...
  'Mixins & Helpers': {
    ...
    'nx-clickable': { content: NxClickablePage, type: 'sass' },
    'nx-container-helpers': { content: NxContainerHelpersPage, type: 'sass' },
    'nx-scrollable': { content: NxScrollablePage, type: 'sass' },
    'nx-viewport-sized': { content: NxViewportSizedPage, type: 'sass' },
  ...
  'JavaScript & TypeScript Utilities': {
    ...
    'ID Utils': { content: IdUtilPage, type: 'js' },
