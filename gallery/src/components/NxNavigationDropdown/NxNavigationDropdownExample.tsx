...
import { NxNavigationDropdown, useToggle, NxTextLink } from '@sonatype/react-shared-components';

function NxNavigationDropdownExample() {
...
export default NxNavigationDropdownExample;
