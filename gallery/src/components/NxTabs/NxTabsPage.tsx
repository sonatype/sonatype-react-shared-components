  ...
  return (
    <>
      <GalleryDescriptionTile>
        ...
        <p>
          The top-level container for tabbed navigation.It can have <code className="nx-code">&lt;NxTabList&gt;</code> and<code className="nx-code">&lt;NxTab&gt;</code> components as children.
        </p>
