...
const NxStatefulCollapsibleMultiSelectDisabledExample = () => {
  const options = [
    {
      id: 'bike',
      name: 'Bicycle'
  ...
  return (
    <NxStatefulCollapsibleMultiSelect name="travel-disabled"
...
export default NxStatefulCollapsibleMultiSelectDisabledExample;
