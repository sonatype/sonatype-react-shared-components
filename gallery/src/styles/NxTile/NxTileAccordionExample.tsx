    ...
    <>
      <section className="nx-tile">
        ...
        <div className="nx-tile-content nx-tile-content--accordion-container">
          <NxStatefulAccordion>
            <NxAccordion.Header>
              <NxAccordion.Title>Bacon</NxAccordion.Title>
            </NxAccordion.Header>
            <p className="nx-p">
          ...
          <NxStatefulAccordion>
            <NxAccordion.Header>
              <NxAccordion.Title>Landjaeger</NxAccordion.Title>
            </NxAccordion.Header>
            <p className="nx-p">
          ...
          <NxStatefulAccordion>
            <NxAccordion.Header>
              <NxAccordion.Title>Drumstick</NxAccordion.Title>
            </NxAccordion.Header>
            <p className="nx-p">
          ...
          <NxStatefulAccordion>
            <NxAccordion.Header>
              <NxAccordion.Title>Prosciutto</NxAccordion.Title>
            </NxAccordion.Header>
            <p className="nx-p">
          ...
          <NxStatefulAccordion>
            <NxAccordion.Header>
              <NxAccordion.Title>Short Loin</NxAccordion.Title>
            </NxAccordion.Header>
            <p className="nx-p">
      ...
      <section className="nx-tile">
        <header className="nx-tile-header">
          <div className="nx-tile-header__title">
            <h2 className="nx-h2">Tile with normal content and an accordion</h2>
          </div>
        </header>
