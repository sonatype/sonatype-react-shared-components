...
describe("Small NxButton section", function () {
  ...
  describe("Small Primary NxButton", function () {
    ...
    it(
      "has a white inner outline and dark blue background when focused and hovered",
  ...
  describe("Small Secondary NxButton", function () {
    ...
    it(
      "has a blue border and white background by default",
      simpleTest(secondarySelector)
    );
    it("has a blue background when hovered", hoverTest(secondarySelector));
    it(
      "has a blue border and light blue background when clicked",
      clickTest(secondarySelector)
    );
    it(
      "has a blue border and darker blue inner outline when focused",
      focusTest(secondarySelector)
    );
    it(
      "has a blue border, darker blue inner outline and blue background when focused and hovered",
  ...
  describe("Small Tertiary NxButton", function () {
    ...
    it(
      "has a light indigo background when hovered",
      hoverTest(tertiarySelector)
    );
    it(
      "has a light grey border and light indigo background when clicked",
      clickTest(tertiarySelector)
    );
    it(
      "has a darker grey inner outline when focused",
      focusTest(tertiarySelector)
    );
    it(
      "has a darker grey inner outline and light indigo background when focused and hovered",
  ...
  describe("Small Error NxButton", function () {
    ...
    it(
      "has a dark red background and white inner outline when focused and hovered",
  ...
  describe("Small Disabled NxButton", function () {
    const disabledSelector =
      "#nx-button-small-example .nx-btn--small[disabled]";
