...
export default function NxBinaryDonutChartMinimalExample() {
  return (
    <>
      ...
      <NxBinaryDonutChart percent={15} aria-label="15 out of 100 components identified" />
      ...
      <NxBinaryDonutChart percent={90} aria-label="90 out of 100 components identified" />
