...
export const StableUniqueIdContext = createContext<ContextBox | null>(null);
...
export function getUniqueId(prefix: string) {
  ...
  const contextBox = useContext(StableUniqueIdContext),
      counter = contextBox ? ++contextBox.value : ++globalCounter;

  console.log('contextBox', contextBox);
