...
const crumbs = [
  ...
  { name: 'Laniakea Supercluster', href: 'https://en.wikipedia.org/wiki/Laniakea_Supercluster' },
  { name: 'Virgo Supercluster', href: 'https://en.wikipedia.org/wiki/Virgo_Supercluster' },
